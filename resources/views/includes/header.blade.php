...
<header class="header" style="min-height: 70px !important;">
        ...
        <div class="text-left col">
            <a class="navbar-brand" href="#">
                <div class="icon icon-44 text-white" style="height: 40px;width: 40px;">
                    ...
                    <img src="/{{ \App\Model\Setting::find(1)->logo_site }}" alt="{{\App\Model\Setting::find(1)->title}}" style="width: 100%;">
                </div>
                <a href="#" class="px-3 text-dark h6">{{\App\Model\Setting::find(1)->title}}</a>
            </a>
        </div>
