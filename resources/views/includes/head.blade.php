<head>
    ...
    <title>{{\App\Model\Setting::find(1)->title}}</title>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ \App\Model\Setting::find(1)->icon_site }}">
    <link rel="icon" type="image/x-icon" href="{{ \App\Model\Setting::find(1)->icon_site }}"> 
